package com.chumu.dt.v24.permissions.encryption;
...
public class ChuMuRSAUtils {
    ...
    private static synchronized KeyPair generateKeyPair() {
        try {
            ...
            System.out.println("ChuMuRSAUtils#KEY_PAIR_GEN is null, can not generate KeyPairGenerator instance.");
            ex.printStackTrace();
        }
        return null;
    }
    ...
    public static RSAPublicKey generateRSAPublicKey(byte[] modulus, byte[] publicExponent) {
        ...
        try {
            ...
            System.out.println("ChuMuRSAUtils#KEY_FACTORY is null, can not generate KeyFactory instance.");
            ex.printStackTrace();
        }
        return null;
    }
    ...
    public static RSAPrivateKey getRSAPrivateKey(String hexModulus, String hexPrivateExponent) {
        ...
        try {
            modulus = ChuMuConvertUtils.hexStringToBytes(hexModulus);
            privateExponent = ChuMuConvertUtils.hexStringToBytes(hexPrivateExponent);
        } catch (Exception ex) {
    ...
    public static RSAPublicKey getRSAPublicKey(String hexModulus, String hexPublicExponent) {
        ...
        try {
            modulus = ChuMuConvertUtils.hexStringToBytes(hexModulus);
            publicExponent = ChuMuConvertUtils.hexStringToBytes(hexPublicExponent);
        } catch (Exception ex) {
    ...
    public static String encryptString(PublicKey publicKey, String plaintext) {
        ...
        try {
            ...
            return new String(ChuMuConvertUtils.bytesToHexString(en_data));
        } catch (Exception ex) {
            ex.printStackTrace();
        }
        return null;
    ...
    public static String decryptString(PrivateKey privateKey, String encrypttext) {
        ...
        try {
            byte[] en_data = ChuMuConvertUtils.hexStringToBytes(encrypttext);
