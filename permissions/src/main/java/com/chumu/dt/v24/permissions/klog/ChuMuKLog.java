...
import com.chumu.dt.v24.permissions.klog.base.ChuMuBaseLog;
import com.chumu.dt.v24.permissions.klog.base.FileLog;
import com.chumu.dt.v24.permissions.klog.base.JsonLog;
import com.chumu.dt.v24.permissions.klog.base.XmlLog;
...
public class ChuMuKLog {
    ...
    public static final String NULL_TIPS = "ChuMuKLog with null object";

    private static final String DEFAULT_MESSAGE = "execute";
    private static final String PARAM = "Param";
    private static final String NULL = "null";
    private static final String TAG_DEFAULT = "ChuMuKChuMuKLog";
    ...
    private static boolean IS_SHOW_ChuMuKLog = true;

    public static void init(boolean isShowChuMuKLog) {
        IS_SHOW_ChuMuKLog = isShowChuMuKLog;
    }

    public static void init(boolean isShowChuMuKLog, @Nullable String tag) {
        IS_SHOW_ChuMuKLog = isShowChuMuKLog;
        mGlobalTag = tag;
    ...
    public static void v() {
        printChuMuKLog(V, null, DEFAULT_MESSAGE);
    }

    public static void v(Object msg) {
        printChuMuKLog(V, null, msg);
    }

    public static void v(String tag, Object... objects) {
        printChuMuKLog(V, tag, objects);
    }

    public static void d() {
        printChuMuKLog(D, null, DEFAULT_MESSAGE);
    }

    public static void d(Object msg) {
        printChuMuKLog(D, null, msg);
    }

    public static void d(String tag, Object... objects) {
        printChuMuKLog(D, tag, objects);
    }

    public static void i() {
        printChuMuKLog(I, null, DEFAULT_MESSAGE);
    }

    public static void i(Object msg) {
        printChuMuKLog(I, null, msg);
    }

    public static void i(String tag, Object... objects) {
        printChuMuKLog(I, tag, objects);
    }

    public static void w() {
        printChuMuKLog(W, null, DEFAULT_MESSAGE);
    }

    public static void w(Object msg) {
        printChuMuKLog(W, null, msg);
    }

    public static void w(String tag, Object... objects) {
        printChuMuKLog(W, tag, objects);
    }

    public static void e() {
        printChuMuKLog(E, null, DEFAULT_MESSAGE);
    }

    public static void e(Object msg) {
        printChuMuKLog(E, null, msg);
    }

    public static void e(String tag, Object... objects) {
        printChuMuKLog(E, tag, objects);
    }

    public static void a() {
        printChuMuKLog(A, null, DEFAULT_MESSAGE);
    }

    public static void a(Object msg) {
        printChuMuKLog(A, null, msg);
    }

    public static void a(String tag, Object... objects) {
        printChuMuKLog(A, tag, objects);
    }

    public static void json(String jsonFormat) {
        printChuMuKLog(JSON, null, jsonFormat);
    }

    public static void json(String tag, String jsonFormat) {
        printChuMuKLog(JSON, tag, jsonFormat);
    }

    public static void xml(String xml) {
        printChuMuKLog(XML, null, xml);
    }

    public static void xml(String tag, String xml) {
        printChuMuKLog(XML, tag, xml);
    }
    ...
    private static void printStackTrace() {
        ...
        for (String trace : traceString) {
            if (trace.contains("at com.socks.library.ChuMuKChuMuKLog")) {
                continue;
            }
    ...
    private static void printChuMuKLog(int type, String tagStr, Object... objects) {
        ...
        switch (type) {
            ...
            case E:
            case A:
                ChuMuBaseLog.printDefault(type, tag, headString + msg);
                break;
            case JSON:
