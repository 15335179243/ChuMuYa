...
public class ViewDragHelper {
     ...
     * callback's
     * {@link  com.chumu.dt.v24.magicbox.swipeback.util.ViewDragHelper.Callback#onEdgeTouched(int, int)}
     * and
     * {@link  com.chumu.dt.v24.magicbox.swipeback.util.ViewDragHelper.Callback#onEdgeDragStarted(int, int)}
     ...
     * {@link  com.chumu.dt.v24.magicbox.swipeback.util.ViewDragHelper.Callback#tryCaptureView(View, int)}
     ...
     * {@link  com.chumu.dt.v24.magicbox.swipeback.util.ViewDragHelper.Callback#getOrderedChildIndex(int)}
     * .
     *
     * @param x X position to test in the parent's coordinate system
     * @param y Y position to test in the parent's coordinate system
