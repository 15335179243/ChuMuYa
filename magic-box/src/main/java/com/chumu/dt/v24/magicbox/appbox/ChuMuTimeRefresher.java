 ...
 */
public class ChuMuTimeRefresher {
    ...
    private ChuMuTimeRefresher() {
        refreshMap = new HashMap<String, TimeHolder>();
    }

    private static ChuMuTimeRefresher sChuMuTimeRefresher;

    public static ChuMuTimeRefresher getInstance() {
        if (sChuMuTimeRefresher == null) {
            sChuMuTimeRefresher = new ChuMuTimeRefresher();
        }

        return sChuMuTimeRefresher;
    }
