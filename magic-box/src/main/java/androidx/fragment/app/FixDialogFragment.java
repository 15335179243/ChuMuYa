...
public class FixDialogFragment extends Fragment
     ...
     * Dialog.setCancelable(boolean)}, because ChuMuDialogFragment needs to change
     ...
     * class.
     *
     * <p><em>Note: ChuMuDialogFragment own the {@link Dialog#setOnCancelListener
        ...
        if (view != null) {
            if (view.getParent() != null) {
                throw new IllegalStateException(
                        "ChuMuDialogFragment can not be attached to a container view");
            }
